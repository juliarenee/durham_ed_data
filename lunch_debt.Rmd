...
*Oct. 2018 CEP eligibility data from \href{ncpublicschools.gov}{https://childnutrition.ncpublicschools.gov/information-resources/eligibility/community-eligibility-provision-cep/community-eligibility-provision?searchterm=CEP}
...
79671.11/sum(df$unpaid[df$ts==2017])
```
