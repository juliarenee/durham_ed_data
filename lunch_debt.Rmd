...
# break up into datasets by year
dem11 = dem[dem$year=="2010-11",]
dem12 = dem[dem$year=="2011-12",]
dem13 = dem[dem$year=="2012-13",]
dem14 = dem[dem$year=="2013-14",]
dem15 = dem[dem$year=="2014-15",]
dem16 = dem[dem$year=="2015-16",]
...
```{r}
df %>%
  filter(year == "2017-18", debt_per_student > 25) %>%
  select(school_name, school_no, adm, unpaid, debt_per_student, grade) %>%
  arrange(-debt_per_student)
```
